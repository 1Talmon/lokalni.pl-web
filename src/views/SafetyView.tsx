'use client';
import { ArrowLeft, ShieldCheck, Lock, AlertTriangle, CheckCircle, Mail, UserCheck } from 'lucide-react';
            ...
            <div className="max-w-3xl mx-auto px-6 py-12">
                <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 md:p-12">
                    ...
                    <div className="space-y-12">
                        ...
                        {/* Sekcja 2: Bezpieczne transakcje */}
                        <section>
                            <h3 className="text-sm uppercase tracking-widest font-bold text-[#6366F1] mb-6 flex items-center gap-2">
                        ...
                        <section>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {[
                                    ...
                                    <div key={i} className="flex items-center gap-3 p-4 bg-gray-50 rounded-2xl border border-gray-100 text-xs font-medium text-gray-600">
