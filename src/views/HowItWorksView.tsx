'use client';
import { ArrowLeft, Search, Star, CheckCircle, Rocket, ShieldCheck } from 'lucide-react';
                    ...
                    <div className="p-8 md:p-12 space-y-16">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                {[
                                    { 
                                        step: "01", 
                                        title: "Znajdź usługę", 
                                        desc: "Wpisz czego potrzebujesz i wybierz lokalizację. Przeglądaj profile z opiniami." 
                                    },
                                    { 
                                        step: "02", 
                                        title: "Ustal szczegóły", 
                                        desc: "Skontaktuj się bezpośrednio przez czat, aby omówić zakres prac i termin." 
                                    },
                                    { 
                                        step: "03", 
                                        title: "Wystaw opinię", 
                                        desc: "Po zakończonym zleceniu oceń współpracę, pomagając budować lokalną społeczność." 
                                    }
                                ].map((item, i) => (
                                    <div key={i} className="relative p-6 bg-gray-50 rounded-2xl border border-gray-100">
                        ...
                        <section>
                            ...
                            <div className="space-y-6">
                                {[
                                    { 
                                        title: "Stwórz profesjonalny profil", 
                                        text: "Zarejestruj się i uzupełnij swoje portfolio oraz zakres oferowanych usług, aby przyciągnąć klientów." 
                                    },
                                    { 
                                        title: "Otrzymuj zapytania bezpośrednio", 
                                        text: "Zlecenia od klientów z Twojej okolicy trafią prosto na Twój panel lub skrzynkę mailową." 
                                    },
                                    { 
                                        title: "Rozwijaj swój lokalny biznes", 
                                        text: "Buduj renomę dzięki zbieranym opiniom i zyskuj stałych klientów w swojej okolicy." 
                                    }
                                ].map((item, i) => (
                                    <div key={i} className="flex gap-4 items-start p-5 rounded-2xl bg-white border border-gray-100 hover:border-indigo-100 transition-colors">
