'use client';
import { ArrowLeft, Lock, Eye, Database, ShieldCheck, Cookie, Mail, MapPin, Bell, Fingerprint, MessageSquare, UserCheck } from 'lucide-react';
...
const PrivacyPolicyView = () => {
    ...
    const _SectionBadge = ({ n }: { n: number }) => (
                        ...
                        <section>
                            ...
                            <div className="pl-9 space-y-4">
                                ...
                                <div className="space-y-4">
                                    {[
                                        {
                                            cel: 'Rejestracja Konta i świadczenie usług',
                                            podstawa: 'art. 6 ust. 1 lit. b RODO — niezbędność do wykonania umowy',
                                            dane: 'adres e-mail, imię, hasło (przechowywane w postaci zaszyfrowanej).',
                                        },
                                        {
                                            cel: 'Weryfikacja wieku i zgoda rodzicielska (osoby w wieku 13–15 lat)',
                                            podstawa: 'art. 6 ust. 1 lit. c RODO w zw. z art. 8 RODO — wypełnienie obowiązku prawnego; przetwarzanie danych dziecka na podstawie zgody rodzica/opiekuna prawnego',
                                            dane: 'data urodzenia (opcjonalna — podana dobrowolnie celem weryfikacji wieku), adres e-mail rodzica lub opiekuna prawnego, jednorazowy token weryfikacyjny (przechowywany tymczasowo do momentu potwierdzenia).',
                                        },
                                        {
                                            cel: 'Logowanie przez Google / Facebook',
                                            podstawa: 'art. 6 ust. 1 lit. b RODO — wykonanie umowy',
                                            dane: 'identyfikator i adres e-mail z konta dostawcy logowania społecznościowego.',
                                        },
                                        {
                                            cel: 'Obsługa funkcji kalendarza i rezerwacji',
                                            podstawa: 'art. 6 ust. 1 lit. b RODO — wykonanie umowy',
                                            dane: 'daty, godziny, dane stron rezerwacji.',
                                        },
                                        {
                                            cel: 'Wewnętrzny system wiadomości (czat)',
                                            podstawa: 'art. 6 ust. 1 lit. b RODO — wykonanie umowy',
                                            dane: 'treść wiadomości, dane nadawcy i odbiorcy, znaczniki czasu.',
                                        },
                                        {
                                            cel: 'Wyświetlanie usług w pobliżu',
                                            podstawa: 'art. 6 ust. 1 lit. a RODO — zgoda użytkownika',
                                            dane: 'lokalizacja GPS lub wskazane miasto.',
                                        },
                                        {
                                            cel: 'Profil Usługodawcy (zdjęcia, opis, portfolio)',
                                            podstawa: 'art. 6 ust. 1 lit. b RODO — wykonanie umowy',
                                            dane: 'zdjęcia, opis, kategoria usług, cennik, kompetencje.',
                                        },
                                        {
                                            cel: 'Powiadomienia push',
                                            podstawa: 'art. 6 ust. 1 lit. a RODO — zgoda użytkownika',
                                            dane: 'token urządzenia mobilnego.',
                                        },
                                        {
                                            cel: 'Bezpieczeństwo i zapobieganie nadużyciom',
                                            podstawa: 'art. 6 ust. 1 lit. f RODO — prawnie uzasadniony interes Administratora',
                                            dane: 'logi systemowe, adres IP, dane sesji.',
                                        },
                                        {
                                            cel: 'Wypełnienie obowiązków prawnych',
                                            podstawa: 'art. 6 ust. 1 lit. c RODO — obowiązek prawny',
                                            dane: 'dane niezbędne do celów podatkowych, rachunkowych lub na żądanie organu.',
                                        },
                                        {
                                            cel: 'Marketing własny i informowanie o zmianach',
                                            podstawa: 'art. 6 ust. 1 lit. f RODO — prawnie uzasadniony interes Administratora',
                                            dane: 'adres e-mail zarejestrowanego Konta.',
                                        },
